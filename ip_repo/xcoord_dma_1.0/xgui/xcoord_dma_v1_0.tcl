...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_NUM_BURSTS"

}

proc update_PARAM_VALUE.C_M_NUM_BURSTS { PARAM_VALUE.C_M_NUM_BURSTS } {
	# Procedure called to update C_M_NUM_BURSTS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_NUM_BURSTS { PARAM_VALUE.C_M_NUM_BURSTS } {
	# Procedure called to validate C_M_NUM_BURSTS
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_NUM_BURSTS { MODELPARAM_VALUE.C_M_NUM_BURSTS PARAM_VALUE.C_M_NUM_BURSTS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_NUM_BURSTS}] ${MODELPARAM_VALUE.C_M_NUM_BURSTS}
}
