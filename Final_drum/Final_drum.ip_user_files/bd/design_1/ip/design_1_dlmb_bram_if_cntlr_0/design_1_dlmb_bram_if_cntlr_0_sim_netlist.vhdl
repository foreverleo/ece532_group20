...
-- Date        : Tue Apr  1 01:29:38 2025
-- Host        : hingir running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/lny/Desktop/FourthYear/ece532/airDrum/audioACLHdmi_WORKING_V2/audioACLHdmi_WORKING_V2.srcs/sources_1/bd/design_1/ip/design_1_dlmb_bram_if_cntlr_0/design_1_dlmb_bram_if_cntlr_0_sim_netlist.vhdl
...
entity design_1_dlmb_bram_if_cntlr_0_lmb_bram_if_cntlr is
  ...
  attribute C_MASK of design_1_dlmb_bram_if_cntlr_0_lmb_bram_if_cntlr : entity is "64'b0000000000000000000000000000000011000101000000110010000000000000";
...
\BRAM_WEN_A[0]_INST_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\No_ECC.Sl_Rdy_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \^lmb_abus\(14),
      I2 => \^lmb_abus\(18),
      I3 => \BRAM_WEN_A[0]_INST_0_i_1_n_0\,
      I4 => LMB_Rst,
...
architecture STRUCTURE of design_1_dlmb_bram_if_cntlr_0 is
  ...
  attribute C_MASK : string;
  attribute C_MASK of U0 : label is "64'b0000000000000000000000000000000011000101000000110010000000000000";
  attribute C_MASK1 : string;
  ...
  attribute x_interface_parameter of LMB_Clk : signal is "XIL_INTERFACENAME CLK.LMB_Clk, ASSOCIATED_BUSIF SLMB:SLMB1:SLMB2:SLMB3, ASSOCIATED_RESET LMB_Rst, FREQ_HZ 100000000, PHASE 0, CLK_DOMAIN design_1_mig_7series_0_0_ui_clk, INSERT_VIP 0";
