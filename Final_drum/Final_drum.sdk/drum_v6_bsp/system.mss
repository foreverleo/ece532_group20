...
BEGIN PROCESSOR
 ...
 PARAMETER compiler_flags =  -mlittle-endian -mxl-pattern-compare -mno-xl-soft-mul -mhard-float -mno-xl-soft-div -mcpu=v11.0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = PmodACL2
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = PmodACL2_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.2
 PARAMETER HW_INSTANCE = axi_uartlite_1_hdmi
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = xcoord_dma_0
END
